...
export async function getSqrtRatioAtTick(tick: number) {
    const helper = await ethers.getContractAt('Helper', "0x5D19aaF8A29643d72d99bBc9bcCd72536518929E");
    return await helper.getSqrtRatioAtTick(tick);
}
...
//     let ratio = !absTick.and(1).eq(0) ? BigNumber.from("0xfffcb933bd6fad37aa2d162d1a594001") : BigNumber.from("0x100000000000000000000000000000000");
